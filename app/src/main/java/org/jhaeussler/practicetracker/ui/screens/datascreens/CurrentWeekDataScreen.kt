...
fun CurrentWeekDataScreen(
    ...
    ScreenContainer(
        title = R.string.current_week_stats_screen_title
    ) {
        Column(
            modifier = Modifier
                .fillMaxWidth()
            ...
            ScrollableTable(
                ...
                data = listOf(
                    ...
                    Pair(
                        listOf("Days played",
                            uiState.getNumOfDaysPlayedThisWeek()
                        ),
                        null
                    ),
                    Pair(
                        listOf("Best Day(s) this Week",
                            uiState.getBestDayThisWeek()
                        ),
                        null
                    )
                )
